...
class WebEditTattooAndProductHelper {
  BuildContext context;
  ScreenshotController screenshotController;

  WebEditTattooAndProductHelper(this.context, this.screenshotController);
      ...
      return homeRead.imagePreview
          ...
          : Row(
              ...
              children: [
                ...
                //     Navigator.pushNamed(
                //         context, route.selectCategoryScreenRoute);
                //   },
                //   child: Container(
                ...
                //       color: mobileScreen.secondContainerClicked
  ...
  Widget boxContainer({onPressed, icon, text, boxColor, scale}) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            containerImprintStyle(title: 'Direct to Film', onPressed: () {}),
            SizedBox(
              width: 15,
            ),
            containerImprintStyle(title: 'Emriodery', onPressed: () {}),
            SizedBox(
              width: 15,
            ),
            containerImprintStyle(title: 'Direct to Garment', onPressed: () {}),
            SizedBox(
              width: 15,
            ),
            containerImprintStyle(title: 'Patch', onPressed: () {}),
          ],
        ),
      ],
    );
  ...
  containerImprintStyle({title, onPressed}) {
    return Expanded(
      child: GestureDetector(
        onTap: onPressed,
        child: Container(
          ...
          child: Center(
            ...
            '$title',
            textAlign: TextAlign.center,
            style: TextStyle(height: 1.0, color: Colors.white, fontSize: 15),
          )),
        ),
      ),
    );
  ...
  selectContainer({icon, text, onPressed}) {
    return Expanded(
      child: GestureDetector(
        onTap: onPressed,
        child: Column(
          children: [
            ...
            Text(
              '$text',
              style: TextStyle(height: 1.0, color: Colors.white, fontSize: 12),
              textAlign: TextAlign.center,
            )
          ],
        ),
